...
class DataNodeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReplicateChunk = channel.unary_unary(
                '/DataNodeService/ReplicateChunk',
                request_serializer=protocol__pb2.ReplicateChunkRequest.SerializeToString,
                response_deserializer=protocol__pb2.ReplicateChunkResponse.FromString,
                )
...
def add_DataNodeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReplicateChunk': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protocol__pb2.ReplicateChunkRequest.FromString,
                    response_serializer=protocol__pb2.ReplicateChunkResponse.SerializeToString,
            ),
...
class DataNodeService(object):
    ...
    def ReplicateChunk(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DataNodeService/ReplicateChunk',
            protocol__pb2.ReplicateChunkRequest.SerializeToString,
            protocol__pb2.ReplicateChunkResponse.FromString,
